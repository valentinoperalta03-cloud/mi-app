export default function MatchDetailLoading() {
  return (
    <div className="mx-auto min-h-screen w-full max-w-md space-y-6 bg-transparent px-4 pb-28 pt-6">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 dark:border-slate-800">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-5 dark:border-slate-800">
