  ...
  return (
    <MotionPage className="mx-auto flex min-h-screen w-full max-w-md flex-col space-y-6 bg-transparent px-4 pb-24 pt-6">
      <section className="rounded-3xl bg-sky-600 p-6 text-white shadow-sm">
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-tight leading-tight">Todo listo para tu partido.</h1>
      ...
      <section className="space-y-3">
        <h3 className="text-2xl font-bold tracking-tight text-slate-950">Proximo partido</h3>
        <article className="rounded-3xl bg-sky-600 p-5 text-white shadow-sm">
          <p className="text-xl font-bold">Dobles intermedio</p>
          <p className="text-sm font-light text-blue-100">Padel Club Centro</p>
          <Link
            href="/partidos"
      ...
      <section className="space-y-3">
        <h3 className="text-2xl font-bold tracking-tight text-slate-950">Tu resumen</h3>
