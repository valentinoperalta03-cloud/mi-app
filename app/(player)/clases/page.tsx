...
export default function ClasesPage() {
  return (
    <MotionPage className="mx-auto min-h-screen w-full max-w-md bg-[var(--bg-app)] px-4 pb-24 pt-5">
      <PlayerStackHeader
        backHref="/home"
        backLabel="Volver al inicio"
        title="Aprender"
        subtitle="Clases y entrenamientos"
      />

      <article className="mt-4 w-full rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] p-8 text-center shadow-[0_2px_16px_-4px_rgba(15,23,42,0.08)]">
        ...
        <h2 className="mt-4 text-2xl font-bold tracking-tight text-[var(--text-primary)]">Próximamente</h2>
