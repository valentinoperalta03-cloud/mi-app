...
export default function ComunidadPage() {
  return (
    <MotionPage className="mx-auto min-h-screen w-full max-w-md space-y-8 bg-slate-50 px-4 pb-32 pt-6">
      <header className="space-y-2">
        <p className="text-sm font-medium text-sky-600">Comunidad</p>
        <h1 className="text-3xl font-bold tracking-tight text-slate-900">Tu espacio social</h1>
