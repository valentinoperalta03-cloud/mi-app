...
/** 4 diapositivas, 2 preguntas cada una — 8 preguntas en total (P1–P8). */
export const ONBOARDING_QUIZ_SLIDES: OnboardingSlideData[] = [
  {
    questions: [
      {
        key: "p1",
        question: "¿Hace cuánto jugás al pádel?",
        options: [
  ...
  },
  {
    questions: [
      {
        key: "p7",
        question: "¿Qué nivel se consideran los jugadores con los que solés jugar?",
        options: [
      ...
      {
        key: "p8",
        question: "¿Qué nivel solés decir que sos cuando te preguntan?",
        options: [
          { value: "octava", label: "8va o no sé" },
          { value: "septima", label: "7ma" },
          { value: "sexta", label: "6ta" },
