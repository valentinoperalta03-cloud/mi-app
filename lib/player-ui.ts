...
export const PLAYER_PRIMARY_BUTTON =
  ...
  "bg-[#0585FC] shadow-[0_2px_8px_rgba(5,133,252,0.3)] " +
  "transition-all duration-200 " +
  "hover:bg-[#0461C4] hover:-translate-y-0.5 " +
  "active:scale-[0.98]";
...
export const PLAYER_SECONDARY_BUTTON =
  ...
  "transition-all duration-200 " +
  "hover:border-[#0585FC]/30 hover:text-[#0585FC] " +
  "active:scale-[0.98]";

export const PLAYER_CARD_HIGHLIGHT =
  "rounded-2xl border border-[#0585FC]/20 " +
  "bg-[#0585FC]/5 shadow-sm";
