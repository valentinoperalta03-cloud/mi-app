      ...
      >
        ...
        <div className="space-y-5 px-5 py-5">
          ...
          {peerOptions.length > 1 ? (
            <label className="block space-y-1.5">
              ...
              <select
                ...
                className="w-full rounded-2xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-800 outline-none focus:border-sky-300 focus:ring-2 focus:ring-sky-200/60"
              >
          ...
          <button
            ...
            className="w-full rounded-3xl bg-sky-600 py-3.5 text-sm font-semibold text-white shadow-md transition hover:bg-sky-500 disabled:cursor-not-allowed disabled:opacity-45"
          >
