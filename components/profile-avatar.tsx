...
export function ProfileAvatar({
  ...
  name,
  size = 96,
  ringClassName = "ring-4 ring-[#0085FC]/40",
}: {
  ...
  return (
    <div
      className={`flex items-center justify-center rounded-full bg-gradient-to-br from-[#0085FC] to-cyan-500 font-semibold tracking-tight text-white ${ringClassName}`}
