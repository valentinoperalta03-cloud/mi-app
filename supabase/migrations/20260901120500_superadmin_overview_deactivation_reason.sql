-- Expone clubs.deactivation_reason (ver 20260901120000) en la vista del
-- superadmin para poder distinguir en UI/observabilidad si un club esta
-- is_active=false por baja manual o por vencimiento de suscripcion.
